...
void writeGeneratedFile(
  ...
  file.writeAsStringSync(
    generateWhiteLabelSource(config, tenantId, envName: envName),
  );
}
...
String _runtimeLiteral(TenantConfig config, TenantEnvironment environment) {
  ...
  return 'WhiteLabelRuntime('
      ...
      '${_dartStringOrNull(environment.apiBaseUrl)}, '
      'custom: ${_dartStringMap(environment.custom)}'
