...
— not re-modeled by `white_label_kit` itself. Both are already real
dependencies of this package, so `dart run icons_launcher:create` /
`dart run flutter_native_splash:create` resolve for your app with nothing
added to your own `pubspec.yaml`.
