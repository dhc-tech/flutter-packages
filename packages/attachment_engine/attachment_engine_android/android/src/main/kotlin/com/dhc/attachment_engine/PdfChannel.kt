...
/**
 * Replaces `pdfx`. Uses [android.graphics.pdf.PdfRenderer] to open a PDF and render pages to PNG
 * bitmaps, keyed by an opaque handle string so the Dart side can hold multiple documents open
 * concurrently.
 *
 * Implements the Pigeon-generated [PdfHostApi] (see the codegen'd `Messages.g.kt`, produced from
 * `attachment_engine_platform_interface/pigeons/messages.dart`) instead of a hand-written
 * `MethodChannel`.
 */
