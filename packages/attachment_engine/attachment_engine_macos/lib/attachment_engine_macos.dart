...
/// The macOS implementation of [AttachmentEnginePlatform].
///
...
/// `macos/attachment_engine_macos/Sources/attachment_engine_macos/`.
///
...
class AttachmentEngineMacos extends AttachmentEnginePlatform {
  /// Registers this class as the default instance of [AttachmentEnginePlatform].
  static void registerWith() {
    AttachmentEnginePlatform.instance = AttachmentEngineMacos();
  }
